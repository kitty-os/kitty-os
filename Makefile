...
cxx_flags := -fpermissive -fno-rtti -Wall -O0 -fno-stack-protector -Wextra -ffreestanding \
    ...
    -Isrc/ -Wformat-security -Wformat -g -I src/acpi/ -mcmodel=large -falign-functions=64
cc_flags := -Wall -O0 -fno-stack-protector -Wextra -ffreestanding \
    ...
    -mno-avx -mno-avx2 -mno-avx512f -mno-red-zone -march=x86-64 -static -Isrc/ -Wformat-security -Wformat -g -I src/flanterm -mcmodel=large -falign-functions=64
